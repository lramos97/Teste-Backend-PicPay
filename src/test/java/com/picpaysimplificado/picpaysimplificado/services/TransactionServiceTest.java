...
class TransactionServiceTest {
    ...
    void createTransactionCase1() throws Exception {
        User sender = new User(1L, "Maria", "Souza", "99999999", "maria@gmail.com", "1234", new BigDecimal(10), UserType.COMMON);
        User receiver = new User(2L, "João", "Souza", "99999992", "João@gmail.com", "1234", new BigDecimal(10), UserType.COMMON);
